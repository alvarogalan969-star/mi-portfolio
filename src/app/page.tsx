      ...
      <section className="full-bleed border-b border-app bg-gradient-to-b from-zinc-50 to-white">
        <div className="mx-auto max-w-6xl px-6 py-24 sm:py-28 text-center bg-app text-app">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            ...
            <a href="/contacto" className="inline-flex items-center justify-center rounded-xl px-5 py-3 font-semibold border border-app text-muted hover:bg-card transition">
              Contactar
            </a>
          </div>
        </div>
