...
export async function generateMetadata(
  // ⬇️ params ahora es Promise y lo resolvemos dentro
...
export default async function LocaleLayout(
  // ⬇️ params también como Promise
  props: Readonly<{ children: React.ReactNode; params: Promise<{ locale: Locale }> }>
) {
  const { children, params } = props;
  const { locale } = await params; // ✅ Next 15

  // Fija el locale y luego carga los mensajes
